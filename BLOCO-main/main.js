...
function criarNota(texto, index) {
    ...
    const botaoEditarIcon = document.createElement('i'); // Ícone de edição
    const botaoExcluir = document.createElement('button');
    const botaoExcluirIcon = document.createElement('i'); // Ícone de exclusão
    ...
    // Define a classe para o botão de edição e o ícone
    botaoEditar.classList.add('botao-editar');
    botaoEditarIcon.classList.add('fa-regular', 'fa-pen-to-square');
    botaoEditar.appendChild(botaoEditarIcon); // Adicione o ícone ao botão de edição

    // Define a classe para o botão de exclusão e o ícone
    botaoExcluir.classList.add('botao-excluir');
    botaoExcluirIcon.classList.add('fa-regular', 'fa-trash-can');
    botaoExcluir.appendChild(botaoExcluirIcon); // Adicione o ícone ao botão de exclusão
...
function editarNota(p, div, inputCor, inputCorTexto) {
    ...
    botaoSalvar.innerHTML = '<i class="fa-solid fa-check"></i>'; // Adicione o ícone ao botão de salvar
